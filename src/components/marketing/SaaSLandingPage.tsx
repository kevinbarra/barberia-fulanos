    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 left-1/4 w-[300px] h-[300px] md:w-[800px] md:h-[800px] bg-brand/5 blur-[50px] md:blur-[150px] rounded-full" />
                <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] md:w-[800px] md:h-[800px] bg-purple-500/5 blur-[50px] md:blur-[150px] rounded-full" />
            </div>
