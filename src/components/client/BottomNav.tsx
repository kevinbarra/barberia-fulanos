 ...
 * - Clients: Plus button (Agendar) as primary action
 * - Staff/Owners: Admin button (Shield) as primary action
 */
export default function BottomNav({ tenantSlug, role }: { tenantSlug: string, role?: string }) {
    ...
    // Different menu based on role
    const menuItems = isAdmin
        ? [
            { name: 'Inicio', href: '/app', icon: Home },
            { name: 'Admin', href: '/admin', icon: ShieldCheck, isSpecial: true },
