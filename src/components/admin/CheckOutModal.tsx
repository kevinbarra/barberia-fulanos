            ...
            {step === 'idle' || step === 'processing' ? (
                <div className="space-y-6">
                    <div className="text-center space-y-1">
                        {!inline && <span className="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-bold uppercase tracking-wider">Por cobrar</span>}
            ...
            <div className="w-full bg-white rounded-xl overflow-hidden flex flex-col">
                <div className="p-4 bg-gray-50/50 border-b border-gray-100 flex justify-between items-center">
                    <h3 className="font-bold text-sm text-gray-900">
                        {step === 'idle' ? 'Cobrar' : step === 'scanning' ? 'Escanear' : 'Éxito'}
                    </h3>
                </div>
                <div className="p-4">
                    {renderContent()}
